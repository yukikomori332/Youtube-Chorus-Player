...
Youtubeの歌ってみた動画や歌枠のアーカイブを複数同時に再生・停止・リピートさせることができるサービスです。好きなアーティストさんや普段は聞かないような方との合唱で思わぬ発見ができるかもしれません。<br/>
Youtube IFrame Player APIを利用して、Youtube URLから動画を追加し、動画の再生管理を行います。<br/>
※Youtube API の利用規約にて、1ページで複数の動画プレイヤーを再生することが禁止されていることを確認したため、サービスを停止しました。<br/>
